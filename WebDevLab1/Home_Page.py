...
st.header("CS 1301")
st.subheader("Web Development - Lab01")
st.subheader("Anaga Holla")
...
1. My Portfolio: Page that showcases my skills and experience.
2. Quiz: Which type of cookie are you?
